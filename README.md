...
## 🛠 Skills & Tools
* **Security Frameworks:** EDR, SIEM, IDS/IPS, NIDS.
* **Tools:** Wazuh, Suricata, Cisco Packet Tracer, Wireshark, Metasploit.
* **Networking:** VLAN, OSPF, VPN, HSRP, TCP/IP Security.
* **Simulations:** VirtualBox, VMWare, DVWA (Damn Vulnerable Web App).

---

> **Note:** These reports are for academic and research purposes, demonstrating the practical application of cybersecurity principles and ethical hacking methodologies in controlled environments.
